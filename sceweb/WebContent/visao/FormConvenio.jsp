...
<body>
	...
	<div id="principal">
		...
		<div id="formulario2">
			...
			<form name="formConvenioIncluir" action="/sceweb/ServletControle"
				method="post">
				<table id="tabcampos">
					...
					<tr>
						...
						<td><input id="campo" size="18" type="text"
							name="txtDtInicio" value=""></td>
					</tr>
					<tr>
						<td><label> Data termino:</label></td>
						<td><input id="campo" size="18" type="text"
							name="txtDtTermino" value=""></td>
					</tr>


					<tr>
						<td colspan=2 id="botoes" align="center"><input id="botao"
							type=button name=btnIncluir onclick=incluir() value=Confirmar>
							<input id="botao" type=reset name=btnCancelar onclick=cancelar()
							value=Cancelar></td>
					</tr>
				</table>
