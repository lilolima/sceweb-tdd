...
<body>
	...
	<div id="principal">
		...
		<div id="formulario2">
			...
			<form name="formEmpresaConsultar"
				action="/sce-web-ref2/ServletControle" method="post">
				<table id="tabcampos">

					<tr>
						<td><label> Nome:</label></td>
						<td><input id="campo" size="90" type="text"
							name="txtNomeDaEmpresa"
					...
					<tr>
						<td colspan=2 id="botoes" align="center"><input id="botao"
							type=reset name=btnLimpar onclick=limpar() value=Limpar>
							<input id="botao" type=button name=btnVoltar onclick=voltar()
							value=Voltar></td>
					</tr>
				</table>
