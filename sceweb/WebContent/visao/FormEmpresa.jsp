...
<body>
	...
	<div id="principal">
		...
		<div id="formulario2">
			...
			<form name="formEmpresaIncluir" action="/sceweb/ServletControle"
				method="post">
				<table id="tabcampos">
					<tr>
						<td><label> Nome:</label></td>
						<td><input id="campo" size="70" type="text"
							name="txtNomeDaEmpresa" value=""></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input id="campo" size="70" type="text"
							name="txtNomeFantasia" value=""></td>
					</tr>
					<tr>
						<td><label> Endereço:</label></td>
						<td><input id="campo" size="50" type="text"
							name="txtEndereco" value=""></td>
					</tr>
					<tr>
						<td><label> Telefone:</label></td>
						<td><input id="campo" size="10" type="text"
							name="txtTelefone" value=""></td>
					</tr>
					<tr>
						<td><label> Responsável pelo Estágio:</label></td>
						<td><input id="campo" size="50" type="text"
							name="txtResponsavel" value=""></td>
					</tr>
					<tr>
						<td><label> Telefone do Responsável pelo Estágio:</label></td>
						<td><input id="campo" size="10" type="text"
							name="txtTelefoneResponsavel" value=""></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan=2 id="botoes" align="center"><input id="botao"
							type=button name=btnIncluir onclick=incluir() value=Incluir>
							<input id="botao" type=reset name=btnConsultar
							onclick=consultar() value=Consultar> <input id="botao"
							type=button name=btnExcluir onclick=excluir() value=Excluir>
						</td>
					</tr>
				</table>
